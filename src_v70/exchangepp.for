...
!======================================================================
              ...
              tag=(2*sync_dir-1)*tag_offset1+cpu_prev
              ta=2*sync_dir
...
!=====> previous cor #1
     ...
     & 3.0d0*fi(ll-nj-nij)+ 1.0d0*fi(ll-nj-1-nij))/64.0d0
              ...
              tag=7*tag_offset1+dom(ib)%corprev1
...
!=====> previous cor #2
     ...
     & 3.0d0*fi(ll-nj-nij)+ 1.0d0*fi(ll-nj+1-nij))/64.0d0
              ...
              tag=9*tag_offset1+dom(ib)%corprev2
...
!=====> previous cor #3
     ...
     & 3.0d0*fi(ll+nj-nij)+ 1.0d0*fi(ll+nj+1-nij))/64.0d0
              ...
              tag=11*tag_offset1+dom(ib)%corprev3
...
!=====> previous cor #4
     ...
     & 3.0d0*fi(ll+nj-nij)+ 1.0d0*fi(ll+nj-1-nij))/64.0d0
              ...
              tag=13*tag_offset1+dom(ib)%corprev4
...
!=====> previous edge #1
     ...
     & 3.0d0*fi(ll-nj-nij)+ 1.0d0*fi(ll-nj+1-nij))/64.0d0
              ...
              tag=15*tag_offset1+dom(ib)%edgprev1
...
!=====> previous edge #2
     ...
     & 3.0d0*fi(ll+nj-nij)+ 1.0d0*fi(ll+nj+1-nij))/64.0d0
              ...
              tag=17*tag_offset1+dom(ib)%edgprev2
...
!=====> previous edge #3
     ...
     & 3.0d0*fi(ll+nj-nij)+ 1.0d0*fi(ll+nj+1-nij))/64.0d0
              ...
              tag=19*tag_offset1+dom(ib)%edgprev3
...
!=====> previous edge #4
     ...
     & 3.0d0*fi(ll+nj-nij)+ 1.0d0*fi(ll+nj-1-nij))/64.0d0
              ...
              tag=21*tag_offset1+dom(ib)%edgprev4
...
!=====> previous edge #5
     ...
     & 3.0d0*fi(ll-nj+nij)+ 1.0d0*fi(ll-nj-1+nij))/64.0d0
              ...
              tag=23*tag_offset1+dom(ib)%edgprev5
...
!=====> previous edge #6
     ...
     & 3.0d0*fi(ll-nj+nij)+ 1.0d0*fi(ll-nj+1+nij))/64.0d0
              ...
              tag=25*tag_offset1+dom(ib)%edgprev6
...
!======================================================================
              ...
              tag=(2*sync_dir)*tag_offset1+cpu_next
              ta=2*sync_dir-1
...
!=====> next cor #1
     ...
     & 3.0d0*fi(ll+nj+nij)+ 1.0d0*fi(ll+nj+1+nij))/64.0d0
              ...
              tag=8*tag_offset1+dom(ib)%cornext1
...
!=====> next cor #2
     ...
     & 3.0d0*fi(ll+nj+nij)+ 1.0d0*fi(ll+nj-1+nij))/64.0d0
              ...
              tag=10*tag_offset1+dom(ib)%cornext2
...
!=====> next cor #3
     ...
     & 3.0d0*fi(ll-nj+nij)+ 1.0d0*fi(ll-nj-1+nij))/64.0d0
              ...
              tag=12*tag_offset1+dom(ib)%cornext3
...
!=====> next cor #4
     ...
     & 3.0d0*fi(ll-nj+nij)+ 1.0d0*fi(ll-nj+1+nij))/64.0d0
              ...
              tag=14*tag_offset1+dom(ib)%cornext4
...
!=====> next edge #1
     ...
     & 3.0d0*fi(ll+nj+nij)+ 1.0d0*fi(ll+nj+1+nij))/64.0d0
              ...
              tag=16*tag_offset1+dom(ib)%edgnext1
...
!=====> next edge #2
     ...
     & 3.0d0*fi(ll+nj+nij)+ 1.0d0*fi(ll+nj-1+nij))/64.0d0
              ...
              tag=18*tag_offset1+dom(ib)%edgnext2
...
!=====> next edge #3
     ...
     & 3.0d0*fi(ll-nj+nij)+ 1.0d0*fi(ll-nj+1+nij))/64.0d0
              ...
              tag=20*tag_offset1+dom(ib)%edgnext3
...
!=====> next edge #4
     ...
     & 3.0d0*fi(ll+nj+nij)+ 1.0d0*fi(ll+nj+1+nij))/64.0d0
              ...
              tag=22*tag_offset1+dom(ib)%edgnext4
...
!=====> next edge #5
     ...
     & 3.0d0*fi(ll+nj+nij)+ 1.0d0*fi(ll+nj+1+nij))/64.0d0
              ...
              tag=24*tag_offset1+dom(ib)%edgnext5
...
!=====> next edge #6
     ...
     & 3.0d0*fi(ll+nj+nij)+ 1.0d0*fi(ll+nj-1+nij))/64.0d0
              ...
              tag=26*tag_offset1+dom(ib)%edgnext6
           ...
           if (dom(ib)%iprev.lt.0) then
              ...
              if (dom(ib)%inext.lt.0) then
                 ...
                 if (dom_ad(dom_id(ib)) .eq. dom_ad(my_cor)) then
                    ...
                    tag1=1*tag_offset3+my_cor    *tag_offset2+dom_id(ib)
                    tag2=2*tag_offset3+dom_id(ib)*tag_offset2+my_cor
           ...
           if (dom(ib)%inext.lt.0) then
              ...
              if (dom(ib)%iprev.lt.0) then
                 ...
                 if (dom_ad(dom_id(ib)) .eq. dom_ad(my_cor)) then
                    ...
                    tag3=2*tag_offset3+my_cor    *tag_offset2+dom_id(ib)
                    tag4=1*tag_offset3+dom_id(ib)*tag_offset2+my_cor
           ...
           if (dom(ib)%jprev.lt.0) then
              ...
              if (dom(ib)%jnext.lt.0) then
                 ...
                 if (dom_ad(dom_id(ib)) .eq. dom_ad(my_cor)) then
                    ...
                    tag1=3*tag_offset3+my_cor    *tag_offset2+dom_id(ib)
                    tag2=4*tag_offset3+dom_id(ib)*tag_offset2+my_cor
                 call MPI_IRECV  (dom(ib)%recvb_m1(1),tsend,MPI_FLT,
     &dom_ad(my_cor),tag2,MPI_COMM_WORLD,dom(ib)%rq_m1,ierr)
                 call MPI_SEND (dom(ib)%sendb_m1(1),tsend,MPI_FLT,
     &dom_ad(my_cor),tag1,MPI_COMM_WORLD,ierr)
           ...
           if (dom(ib)%jnext.lt.0) then
              ...
              if (dom(ib)%jprev.lt.0) then
                 ...
                 if (dom_ad(dom_id(ib)) .eq. dom_ad(my_cor)) then
                    ...
                    tag3=4*tag_offset3+my_cor    *tag_offset2+dom_id(ib)
                    tag4=3*tag_offset3+dom_id(ib)*tag_offset2+my_cor
                 call MPI_IRECV  (dom(ib)%recvb_p1(1),tsend,MPI_FLT,
     &dom_ad(my_cor),tag4,MPI_COMM_WORLD,dom(ib)%rq_p1,ierr)
                 call MPI_SEND (dom(ib)%sendb_p1(1),tsend,MPI_FLT,
     &dom_ad(my_cor),tag3,MPI_COMM_WORLD,ierr)
           ...
           if (dom(ib)%kprev.lt.0) then
              ...
              if (dom(ib)%knext.lt.0) then
                 ...
                 if (dom_ad(dom_id(ib)) .eq. dom_ad(my_cor)) then
                    ...
                    tag1=5*tag_offset3+my_cor    *tag_offset2+dom_id(ib)
                    tag2=6*tag_offset3+dom_id(ib)*tag_offset2+my_cor
                 call MPI_IRECV  (dom(ib)%recvb_m1(1),tsend,MPI_FLT,
     &dom_ad(my_cor),tag2,MPI_COMM_WORLD,dom(ib)%rq_m1,ierr)
                 call MPI_SEND (dom(ib)%sendb_m1(1),tsend,MPI_FLT,
     &dom_ad(my_cor),tag1,MPI_COMM_WORLD,ierr)
           ...
           if (dom(ib)%knext.lt.0) then
              ...
              if (dom(ib)%kprev.lt.0) then
                 ...
                 if (dom_ad(dom_id(ib)) .eq. dom_ad(my_cor)) then
                    ...
                    tag3=6*tag_offset3+my_cor    *tag_offset2+dom_id(ib)
                    tag4=5*tag_offset3+dom_id(ib)*tag_offset2+my_cor
                 call MPI_IRECV  (dom(ib)%recvb_p1(1),tsend,MPI_FLT,
     &dom_ad(my_cor),tag4,MPI_COMM_WORLD,dom(ib)%rq_p1,ierr)
                 call MPI_SEND (dom(ib)%sendb_p1(1),tsend,MPI_FLT,
     &dom_ad(my_cor),tag3,MPI_COMM_WORLD,ierr)
